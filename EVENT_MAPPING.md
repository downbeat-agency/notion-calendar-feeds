...
// Requires: transport.start
{
  ...
  title: "🚙/🚕/🚗 " + (transport.title || "Ground Transport"),  // Pickup: 🚙, Meet Up: 🚕, Drop Off: 🚗
...
- **Event Titles**: Include emojis (✈️ for flights, 🎤 for rehearsals, 🏨 for hotels, 🚙/🚕/🚗 for transport pickup/meet up/drop off, 📅 for team calendar) for easy identification
